...
public class EditContr {
    private Stage stage;
    private HumanBeing persone;
    ...
    void initialize() {
        ...
        var orgTypes = FXCollections.observableArrayList(
                Arrays.stream(WeaponType.values()).map(Enum::toString).collect(Collectors.toList())
        );
    ...
    public Product getPersone() {
        var tmpProduct = persone;
        persone = null;
        return tmpProduct;
    }
